...
ssh $DOCKER_MACHINE_USER@$DOCKER_MACHINE_IP "cd ~/jenkins/workspace; ./build.sh -o url-replace"
ssh $DOCKER_MACHINE_USER@$DOCKER_MACHINE_IP "cd ~/jenkins/workspace; ./build.sh -o build"
ssh $DOCKER_MACHINE_USER@$DOCKER_MACHINE_IP "cd ~/jenkins/workspace; ./build.sh -o deploy"
